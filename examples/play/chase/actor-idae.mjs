...
export function createActorIdae({
  id,
  createState,
  observe,
  deriveSelfState,
  ...
  return createIdaeEngine({
    ...
    createState: () => {
      ...
      assertActorStateShape(state, id ?? "actor-idae");
      return state;
    },
...
export function stepActorIdae(actorIdae, frameContext = {}) {
  return stepIdaeEngine(actorIdae, frameContext);
}
