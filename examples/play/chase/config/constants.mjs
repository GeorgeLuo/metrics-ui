...
export const RENDERING_PROFILE_ACTION_ID = "rendering-profile";
export const RENDERING_SEED_ACTION_ID = "rendering-seed";
export const MIN_RENDERING_SEED = 0;
export const MAX_RENDERING_SEED = 0xffffffff;
...
export const CHASER_ACTION_PROPOSAL_CONSENSUS_COUPLING = 1.2;
export const CHASER_ACTION_PROPOSAL_CONSENSUS_ITERATIONS = 12;
