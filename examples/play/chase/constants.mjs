...
export const SIMULATION_FRAME_DURATION_MS = 1000 / ASSUMED_GAME_FRAMES_PER_SECOND;
export const MAX_SIMULATION_STEPS_PER_TICK = 8;
...
export const DEFAULT_TARGET_PROJECTION_SAMPLE_EVERY_FRAMES = 20;
export const MAX_TARGET_PROJECTION_HORIZON_FRAMES = 600;
export const MAX_TARGET_PROJECTION_SAMPLE_EVERY_FRAMES = 120;
...
export const TARGET_DRIFT_X_PHASE_PER_FRAME = 0.0007 * SIMULATION_FRAME_DURATION_MS;
export const TARGET_DRIFT_Z_PHASE_PER_FRAME = 0.0005 * SIMULATION_FRAME_DURATION_MS;
