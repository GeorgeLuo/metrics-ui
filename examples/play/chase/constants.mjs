...
export const DEFAULT_TARGET_SPEED_UNITS_PER_FRAME = 2.8 / ASSUMED_GAME_FRAMES_PER_SECOND;
export const DEFAULT_TARGET_SPEED_ESTIMATE_UNITS_PER_FRAME = 2.4 / ASSUMED_GAME_FRAMES_PER_SECOND;
...
export const TARGET_PROJECTION_SPACING_ACTION_ID = TARGET_PROJECTION_RATE_ACTION_ID;
...
export const DEFAULT_TARGET_PROJECTION_SPACING_FRAMES = 20;
export const MAX_TARGET_PROJECTION_HORIZON_FRAMES = 600;
export const MAX_TARGET_PROJECTION_SPACING_FRAMES = 120;
...
export const TARGET_SPEED_ESTIMATE_MAX_UNITS_PER_FRAME = 12 / ASSUMED_GAME_FRAMES_PER_SECOND;
...
export const TARGET_PREDICTION_MAX_UNOBSERVED_FRAMES = 75;
export const TARGET_PROJECTION_VALIDATION_LOOKAHEAD_FRAMES = 36;
export const TARGET_PROJECTION_INVALIDATION_DISTANCE = 0.55;
export const DEFAULT_TARGET_DRIFT_X_PHASE_PER_FRAME = 0.0007 * (1000 / ASSUMED_GAME_FRAMES_PER_SECOND);
export const DEFAULT_TARGET_DRIFT_Z_PHASE_PER_FRAME = 0.0005 * (1000 / ASSUMED_GAME_FRAMES_PER_SECOND);
export const DEFAULT_TARGET_DRIFT_WEIGHT = 0.45;
export const DEFAULT_TARGET_WALL_AVOID_WEIGHT = 2.5;
